    ...
    return (
        <>
            ...
            <div>
                ...
                <img
                    className={`w-12 md:w-22 rounded-xl transition-all duration-300 ${media.seen ? 'brightness-50' : ''} ${!imageLoaded ? 'hidden' : ''}`}
            ...
            <div className="flex flex-col space-y-4">
                ...
                <select
                    className={`select cursor-pointer select-xs md:select-md w-22 md:w-auto ${media.seen ? 'flex' : 'hidden'}`}
